...
export const messages = {
  fr: {
    common: {
      ...
      no: "Non",
      seeMore: "Voir plus",
      viewFullText: "Voir le texte complet de {title}",
    ...
    toolbar: {
      ...
      exportMenuTitle: "Choisissez le contenu à exporter",
      exportOptionFrontBoard: "Recto du plateau",
      exportOptionBackBoard: "Textes du verso",
      ...
      backBoardExportName: "textes-verso",
      ...
      backTextsExportTitle: "Textes du verso",
      noBackTextsExport:
        "Aucune carte du plateau ne contient de texte au verso.",
    },
    cardLibrary: {
    ...
    wipPage: {
      ...
      v2Title: "V2 — Plateforme collaborative (2025–mai 2026)",
      v2Body:
      ...
      v21Title: "V2.1 — Mise à jour (mai 2026-aujourd’hui)",
      v21Body:
        "La V2.1 ajoute une version démo, met à jour le tutoriel, apporte quelques ajustements mineurs de design et introduit un export de ruche plus flexible : vous pouvez choisir d’exporter tout le contenu, uniquement le plateau, les commentaires, les notes, etc.",
  ...
  en: {
    common: {
      ...
      no: "No",
      seeMore: "See more",
      viewFullText: "View full text for {title}",
    ...
    toolbar: {
      ...
      exportMenuTitle: "Choose what to export",
      exportOptionFrontBoard: "Board front",
      exportOptionBackBoard: "Back texts",
      exportOptionCardNotes: "Card notes",
      exportOptionChat: "Chat",
      exportSelectAtLeastOne: "Select at least one item to export.",
      ...
      backBoardExportName: "back-texts",
      ...
      backTextsExportTitle: "Back texts",
      noBackTextsExport: "No board card has back text.",
    },
    cardLibrary: {
    ...
    wipPage: {
      ...
      v2Title: "V2 - Collaborative platform (2025-May 2026)",
      v2Body:
      ...
      v21Title: "V2.1 - Update (May 2026-present)",
      v21Body:
        "V2.1 adds a demo version, updates the tutorial, includes a few minor design changes, and introduces more flexible hive export options: you can choose to export everything, only the board, comments, notes, etc.",
  ...
  nl: {
    common: {
      ...
      no: "Nee",
      seeMore: "Meer zien",
      viewFullText: "Volledige tekst van {title} bekijken",
    ...
    landing: {
      ...
      learnMoreText:
        "Ontdek alle informatie over de bijenkorf en zijn verschillende versies.",
      signIn: "Aanmelden",
    ...
    toolbar: {
      ...
      exportMenuTitle: "Kies wat u wilt exporteren",
      exportOptionFrontBoard: "Voorkant van het bord",
      exportOptionBackBoard: "Teksten van de achterkant",
      ...
      backBoardExportName: "achterkant-teksten",
      ...
      backTextsExportTitle: "Teksten van de achterkant",
      noBackTextsExport:
        "Geen enkele kaart op het bord heeft tekst op de achterkant.",
    },
    cardLibrary: {
    ...
    wipPage: {
      ...
      v2Title: "V2 — Collaboratief platform (2025–mei 2026)",
      v2Body:
      ...
      v21Title: "V2.1 — Update (mei 2026-heden)",
      v21Body:
        "V2.1 voegt een demoversie toe, werkt de handleiding bij, bevat enkele kleine designaanpassingen en introduceert flexibelere exportopties voor bijkorven: u kunt alles exporteren, alleen het bord, opmerkingen, notities, enz.",
